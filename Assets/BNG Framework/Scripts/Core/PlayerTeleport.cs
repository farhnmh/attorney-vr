...
namespace BNG
{
    ...
    public class PlayerTeleport : MonoBehaviour
    {
        ...
        [Tooltip("Boundary zone for rotate controller")]
        public float minVertical;
        public float maxVertical;
        public bool usingTeleportStandalone;
        ...
        void LateUpdate()
        {
            ...
            PlayerRotation.AllowInput = !aimingTeleport;
        ...
        public virtual bool KeyDownForTeleport()
        {
            if (usingTeleportStandalone)
            {
                ...
                {
                    if (handedThumbstickAxis.y <= minVertical ||
                        handedThumbstickAxis.y >= maxVertical)
                    {
                        return true;
                    }
                }
